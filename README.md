...
<br>
newspace-news-service 입니다.
<br>
해당 레포지토리에는 AI 뉴스 서비스를 제공하는 스프링 부트 프로젝트가 포함되어있습니다.
<br>
...
└── src
    ...
    │   │               ├── exception
    │   │               │   ├── NewsException.java
    │   │               │   └── NewsResponseStatus.java
    │   │               ├── NewspaceNewsServiceApplication.java
    │   │               ├── repository
    ...
    └── test
        └── java
            └── com
                └── lgcns
                    └── newspacenewsservice
                        └── NewspaceNewsServiceApplicationTests.java
```
<br/>
